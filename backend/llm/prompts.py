...
class Prompts:
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            "{context}\n\n"
            "## Task\n"
            f"You are {self.character.name} and talking to a human. Adopt "
            f"{self.character.name}'s personality described above and "
            "respond to the last message in conversation history. Consider the "
            f"complete conversation history, {self.character.name}'s current "
            f"location, situation, emotional state, goals, personality "
